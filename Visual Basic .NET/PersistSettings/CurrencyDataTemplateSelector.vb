...
' 
' [CurrencyDataTemplateSelector.vb]
'  
...
Namespace Xceed.Wpf.DataGrid.Samples.PersistSettings
  ...
  Public Class CurrencyDataTemplateSelector
    Inherits DataTemplateSelector

#Region "Singleton Property"

    Public Shared ReadOnly Property Singleton() As CurrencyDataTemplateSelector
      Get
    ...
    Private Shared _singleton As CurrencyDataTemplateSelector
...
#Region "PUBLIC METHODS"
    ...
    Public Overrides Function SelectTemplate(ByVal item As Object, ByVal container As DependencyObject) As DataTemplate
      ...
      If (parentDataGrid.View Is Nothing) Or (TypeOf parentDataGrid.View Is Xceed.Wpf.DataGrid.Views.TableView) Then
        ...
        Return TryCast(parentDataGrid.FindResource("currencyCellDataTemplateRightAligned"), DataTemplate)
      End If

      Return TryCast(parentDataGrid.FindResource("currencyCellDataTemplateDefaultAligned"), DataTemplate)
    End Function
