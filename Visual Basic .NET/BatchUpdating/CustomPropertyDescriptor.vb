...
Namespace Xceed.Wpf.DataGrid.Samples.BatchUpdating
  Friend Class CustomPropertyDescriptor
	...
	Public Sub New(ByVal propertyName As String, ByVal componentType As Type, ByVal propertyType As Type, ByVal [readOnly] As Boolean)
	...
	Public Overrides Function GetValue(ByVal component As Object) As Object
	  Return (CType(component, Person)).GetDynamicPropertyValue(Me)
	End Function
