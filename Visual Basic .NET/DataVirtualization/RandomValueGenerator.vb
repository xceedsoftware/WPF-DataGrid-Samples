...
Namespace Xceed.Wpf.DataGrid.Samples.DataVirtualization
  Friend Class RandomValueGenerator
    ...
    Public Shared Function GetRandomPhoneNumber() As String
      Return ("(555) 555-" & RandomValueGenerator.Randomizer.Next(0, 10).ToString() & RandomValueGenerator.Randomizer.Next(0, 10).ToString() & RandomValueGenerator.Randomizer.Next(0, 10).ToString() + RandomValueGenerator.Randomizer.Next(0, 10).ToString())
    End Function
