...
Namespace Xceed.Wpf.DataGrid.Samples.FlexibleBinding
  Public Class ComposersBindingList
...
#Region "Implementation for the typed collection"
    ...
    Default Public Property Item(ByVal index As Integer) As Composer
      Get
        Return CType(Me.List(index), Composer)
      End Get
...
#Region "Implementation of IBindingList"
    ...
    Public Function AddNew() As Object Implements IBindingList.AddNew
      ...
      Dim composer As Composer = New Composer()
    ...
    Protected Overrides Sub OnRemoveComplete(ByVal index As Integer, ByVal value As Object)
      CType(value, Composer).m_containingList = Nothing
    ...
    Protected Overrides Sub OnInsertComplete(ByVal index As Integer, ByVal value As Object)
      CType(value, Composer).m_containingList = Me
    ...
    Protected Overrides Sub OnClear()
      For Each composer As Composer In Me
    ...
    Protected Overrides Sub OnSetComplete(ByVal index As Integer, ByVal oldValue As Object, ByVal newValue As Object)
      ...
      CType(oldValue, Composer).m_containingList = Nothing
      CType(newValue, Composer).m_containingList = Me
