...
Namespace Xceed.Wpf.DataGrid.Samples.TableView
  Partial Public Class FilterDatePicker
...
#Region "FilterCriterion Property"
    ...
    Public Shared ReadOnly FilterCriterionProperty As DependencyProperty = DependencyProperty.Register(
              "FilterCriterion",
              GetType(FilterCriterion),
              GetType(FilterDatePicker),
              New FrameworkPropertyMetadata(
                Nothing,
                FrameworkPropertyMetadataOptions.BindsTwoWayByDefault,
                New PropertyChangedCallback(AddressOf FilterDatePicker.OnFilterCriterionChanged)))
    ...
    Public Property FilterCriterion() As FilterCriteria.FilterCriterion
      ...
      End Get
      Set(ByVal value As FilterCriteria.FilterCriterion)
...
#Region "StartDate Property"
    ...
    Public Shared ReadOnly StartDateProperty As DependencyProperty = DependencyProperty.Register(
              "StartDate",
              GetType(DateTime),
              GetType(FilterDatePicker),
              New FrameworkPropertyMetadata(
                DateTime.MinValue,
                New PropertyChangedCallback(AddressOf FilterDatePicker.OnStartDateChanged)))
...
#Region "EndDate Property"
    ...
    Public Shared ReadOnly EndDateProperty As DependencyProperty = DependencyProperty.Register(
              "EndDate",
              GetType(DateTime),
              GetType(FilterDatePicker),
              New FrameworkPropertyMetadata(
                DateTime.MaxValue,
                New PropertyChangedCallback(AddressOf FilterDatePicker.OnEndDateChanged)))
      ...
      Try
        If Me.StartDate > DateTime.MinValue Then
          If Me.EndDate < DateTime.MaxValue Then
            Me.FilterCriterion = New AndFilterCriterion(
                                      New GreaterThanOrEqualToFilterCriterion(Me.StartDate),
                                      New LessThanOrEqualToFilterCriterion(New DateTime(Me.EndDate.Year, Me.EndDate.Month, Me.EndDate.Day, 23, 59, 59)))
          Else
            Me.FilterCriterion = New GreaterThanOrEqualToFilterCriterion(Me.StartDate)
          End If
        ElseIf Me.EndDate < DateTime.MaxValue Then
          Me.FilterCriterion = New LessThanOrEqualToFilterCriterion(
                                New DateTime(Me.EndDate.Year, Me.EndDate.Month, Me.EndDate.Day, 23, 59, 59))
        End If
      Finally
        m_updating = False
      End Try
