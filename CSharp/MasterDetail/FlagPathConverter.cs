/*
 * Xceed DataGrid for WPF - SAMPLE CODE - MasterDetail Sample Application
...
namespace Xceed.Wpf.DataGrid.Samples.MasterDetail
{
  ...
  {
    private const string FlagsManifestResourcePath = "Xceed.Wpf.DataGrid.Samples.MasterDetail.Flags.";
