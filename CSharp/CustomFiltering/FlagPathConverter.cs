/*
 * Xceed DataGrid for WPF - SAMPLE CODE - CustomFiltering Sample Application
...
namespace Xceed.Wpf.DataGrid.Samples.CustomFiltering
{
  ...
  {
    private const string FlagsManifestResourcePath = "Xceed.Wpf.DataGrid.Samples.CustomFiltering.Flags.";
