/*
 * Xceed DataGrid for WPF - SAMPLE CODE - FlexibleBinding Sample Application
...
namespace Xceed.Wpf.DataGrid.Samples.FlexibleBinding
{
  ...
  {
    private const string FlagsManifestResourcePath = "Xceed.Wpf.DataGrid.Samples.FlexibleBinding.Flags.";
